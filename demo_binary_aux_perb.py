...
from networks import VGG16_binary_aux_perb
...
args = SimpleNamespace(epochs=6,
                       ...
                       # pretrained_weights=r"C:\Users\johny\Desktop\RPL_paper\baseline_binary_aux\stage_1.pth",
...
# #### Stage 1
args.session_name = "baseline_binary_aux_perb/"
#
...
model = VGG16_binary_aux_perb(n_classes=18).cuda()
...
#     class_weight = 45117 / torch.tensor([30160, 2+9757+1004+205+833+4+252+21+7+1366+1323+83+56+26+1+13]).cuda()
#     criterion_binary = nn.CrossEntropyLoss(weight=class_weight)
#
# #
...
#     model.train_epoch(train_loader, optimizer,criterion,criterion_binary)
#
